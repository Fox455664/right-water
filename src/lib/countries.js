...
// قائمة كاملة بالدول مع رموزها وأسمائها بالعربية
...
export const countries = [
  ...
  { value: "TL", label: "تيمور - ليشتي" },
  { value: "JM", label: "جامايكا" },
  { value: "GI", label: "جبل طارق" },
  { value: "AX", label: "جزر أولاند" },
  { value: "AN", label: "جزر الأنتيل الهولندية" },
  ...
  { value: "VI", label: "جزر فيرجن الأمريكية" },
  { value: "VG", label: "جزر فيرجن البريطانية" },
  ...
  { value: "ST", label: "ساو تومي وبرينسيب" },
