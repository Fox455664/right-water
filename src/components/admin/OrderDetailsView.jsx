...
import {
  ...
  Package, Truck, CheckCircle, Clock, XCircle, Printer
} from 'lucide-react';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';

const OrderDetailsView = ({ order, onBack, onStatusChange }) => {
  ...
  return (
    ...
    >
      ...
      <div className="text-right">
        ...
        <p className="text-muted-foreground">تم الإنشاء في {formatDate(order.createdAt)}</p>
      </div>
            ...
            <Card className="glass-effect">
              ...
              <CardContent className="space-y-4 overflow-auto max-h-[400px]">
                {order.items?.length > 0 ? (
                  ...
                  <p className="text-gray-400 text-center">لا توجد منتجات في هذا الطلب.</p>
                )}
            ...
            <Card className="glass-effect neon-glow">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-white">{order.items.length}</span>
                </div>
                <div className="flex justify-between">
