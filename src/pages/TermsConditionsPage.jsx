  ...
  const sections = [
    {
      ...
      content: "مرحبًا بك في موقع رايت ووتر. باستخدامك لموقعنا وخدماتنا، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي جزء من هذه الشروط، فيجب عليك عدم استخدام خدماتنا. نحتفظ بالحق في تعديل هذه الشروط في أي وقت، وستصبح التعديلات سارية فور نشرها.",
    },
    {
...
=======
      content: "جميع المحتويات الموجودة على هذا الموقع، بما في ذلك النصوص والرسومات والشعارات والصور والبرامج، هي ملك لشركة رايت ووتر أو مورديها ومحمية بموجب قوانين حقوق النشر والعلامات التجارية الدولية. لا يجوز لك نسخ أو تعديل أو توزيع أو إعادة إنتاج أي جزء من الموقع دون إذن كتابي صريح منا.",
>>>>>>> 93cd9b3 (تحديثات على صفحة الدفع وسلة التسوق)
    },
    {
...
=======
      content: "إلى أقصى حد يسمح به القانون، لن تكون شركة رايت ووتر مسؤولة عن أي أضرار مباشرة أو غير مباشرة أو عرضية أو خاصة أو تبعية تنشأ عن أو فيما يتعلق باستخدامك لخدماتنا أو عدم قدرتك على استخدامها. يشمل ذلك، على سبيل المثال لا الحصر، الأضرار الناجمة عن خسارة الأرباح أو البيانات أو السمعة التجارية.",
>>>>>>> 93cd9b3 (تحديثات على صفحة الدفع وسلة التسوق)
    },
    {
      icon: <FileText size={28} className="text-sky-500" />,
